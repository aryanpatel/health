 ...
 * @param array $field
 */
function bmps_wp_text_input($field) {
    ...
    switch ($data_type) {
        case 'price' :
            $field['class'] .= ' bmps_input_price';
            $field['value'] = bmps_format_localized_price($field['value']);
            break;
        case 'decimal' :
            $field['class'] .= ' bmps_input_decimal';
            $field['value'] = bmps_format_localized_price($field['value']);
            break;
        case 'slots' :
            $field['class'] .= ' bmps_input_slot';
            $field['value'] = bmps_format_localized_price($field['value']);
            break;
        case 'url' :
            $field['class'] .= ' bmps_input_url';
    ...
    if (!empty($field['description']) && false !== $field['desc_tip']) {
        echo bmps_tool_tip($field['description']);
    }
 ...
 * @param array $field
 */
function bmps_wp_textarea_input($field) {
    global $thepostid, $post;
...
function bmps_wp_select($field) {
    ...
    if (!empty($field['multiple'])) {
        echo '<select id="' . esc_attr($field['id']) . '" name="' . esc_attr($field['name']) . '[]" class="' . esc_attr($field['class']) . '" style="' . esc_attr($field['style']) . '" ' . implode(' ', $custom_attributes) . ' multiple>';
    } else {
 ...
 * @param array $field
 */
function bmps_wp_checkbox($field) {
    global $thepostid, $post;
